...
{Tipo de abordagem} &
  ...
  {\begin{tabular}[c]{@{}l@{}}Quantidade \\ de bagagens \\ de mão\end{tabular}} &
  {\begin{tabular}[c]{@{}l@{}}Quantidade \\ de bagagens \\ de despacho\end{tabular}} &
...
{\begin{tabular}[c]{@{}l@{}}Projeção da IATA \\ (máximo)\end{tabular}} &
  {150} &
  {104} &
  {296} &
  {300} &
  ...
  {6,3} &
  {4,17} \\
{\begin{tabular}[c]{@{}l@{}}Projeção da IATA\\ (médio)\end{tabular}} &
  {150} &
  {104} &
  {296} &
  150 &
  ...
  3,15 &
  2,1 \\
{\begin{tabular}[c]{@{}l@{}}Recomendações \\ Self bag drop (máximo)\end{tabular}} &
  {150} &
  {104} &
  {296} &
  {30} &
  ...
  {1,67} &
  {1,11} \\
{\begin{tabular}[c]{@{}l@{}}Recomendações \\ Self bag drop (ótimo)\end{tabular}} &
  {150} &
  {104} &
  {296} &
  15 &
...
\end{table}
    ...
    Os dados demonstram que, a solução proposta se aproxima dos resultados ótimos, sugerindo a necessidade de melhorias. Comparando os preços dos dispositivos de sef-bag-drop do mercado com os sensores de profundidade, utilizado no produto dessa pesquisa, se tem maior economia direta utilizando 3 esteiras com os sensores de profundidade do que comprando 2 esteiras com o dispositivo do mercado. Cabe recapitular que esse é um cenário simulado, que desconsidera dados dinâmicos e aleatórios, contudo, ele indica que o produto dessa pesquisa tem potencial de ser aplicado na prática. 
